# Operator Quickstart — cloud-itonami-isic-941

Shortest path from clone to a verified local dry-run for **ISIC 941** (`cloud-itonami-isic-941`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-941.git
cd cloud-itonami-isic-941
```
...
- Likely source path: `membershipassocorg.governor.cljc`
