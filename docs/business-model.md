# Business Model: Activities of Business, Employers and Professional Membership Organizations - Administrative Coordination
...
- ISIC Rev.5: `` — Activities of Business, Employers and Professional Membership Organizations - Administrative Coordination
- Domain: `:services/membership-association-coordination`
- Social impact: :operational-efficiency :administrative-transparency :member-services-access
- Actor: `:membershipassocorg-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :services/membership-association-coordination — who wants
...
One managed tenant (:services/membership-association-coordination):
...
- Do not bypass the `:membershipassocorg-governor` for production decisions.
